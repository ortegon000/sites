 ...
 */
#[Fillable(['client_id', 'name', 'management', 'registrar', 'site_url', 'registered_at', 'registration_cost', 'currency', 'expires_at', 'auto_renew', 'email_management', 'email_notes', 'status', 'expiry_notified_at'])]
